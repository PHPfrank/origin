...
$(document).ready(function () {
    ...
    }), $SIDEBAR_MENU.find('a[val="' + CURRENT_URL + '"]').parent("li").addClass("current-page"), $SIDEBAR_MENU.find("a").filter(function () {
...
$(function(){
    if(typeof(_global) != "undefined"){
        $("li").find('a[val="' + _global.sider + '"]').parent("li").addClass("current-page");
        $("li").find('a[val="' + _global.sider + '"]').parent("li").parent("ul").parent("li").addClass('active');
        $("li").find('a[val="' + _global.sider + '"]').parent("li").parent("ul").show();
        $("li").find('a[val="' + _global.sider + '"]').parent("li").siblings().removeClass("current-page");
    }
});