                ...
                <div class="x_title">
                    ...
                    <form class="form-horizontal form-label-left" style="text-align: left;">
                        <div class="form-group">
                            ...
                            <label class="" for="first-name" style="text-align:left;padding-right:1px;padding-left:2px;padding-top:8px;float:left;">&nbsp;&nbsp;账号:</label>
                            <div class="col-md-1" style="width:10%;">
                                <input type="text" id="account"  class="form-control col-md-1" style="border-radius:2px;" placeholder="155454545454">
                            </div>
                            <label class="" for="first-name" style="text-align:left;padding-right:1px;padding-left:2px;padding-top:8px;float:left;">&nbsp;&nbsp;户名:</label>
                            <div class="col-md-1" style="width:10%;">
                                <input type="text" id="name"  class="form-control col-md-1" style="border-radius:2px;" placeholder="张发财">
                            </div>
                            <label class="" for="first-name" style="text-align:left;padding-right:1px;padding-left:1px;padding-top:8px;float:left;">是否被删除:</label>
						...
						<table id="datatable-fixed-header" class="table table-striped table-bordered" style="text-align: center;">
							<thead>
								<tr class="headings">
                                    ...
                                    <th class="column-title" style="text-align: center;">户名</th>
                                    <th class="column-title" style="text-align: center;">是否被用户删除</th>
                                    <th class="column-title" style="text-align: center;">添加时间</th>
                                    <th class="column-title" style="text-align: center;">修改时间</th>
								</tr>
							</thead>
							<tbody id ='data_list'>
    ...
    <script type="text/html" id="item_list">
        ...
        <tr class="even pointer">
            ...
            <td class=" " style="vertical-align:middle;">
                <%if(data[i].is_delete==1){%><font color="green">√</font><%}else{%><font color="red">×</font><%}%>
                </span></td>
...
<script type="text/javascript">
	$(function(){
        ...
        fetch=function(){
            $.ajax({
                url:'/admin/withdraw_account_data',
                dataType:"json",
                type:'get',
                data:_this,
        ...
        $("#search").on("click",function(e){
            _this.page=1;
            _this.is_delete =$.trim($("#is_delete").val());
            _this.account =$.trim($("#account").val());
            _this.name =$.trim($("#name").val());
            _this.sex=$("#sex").val();
