						...
						<table id="datatable-fixed-header" class="table table-striped table-bordered" style="text-align: center;">
							<thead>
								<tr class="headings">
									...
									<th class="column-title" style="text-align: center;width:15%;">会员</th>
                                    {{--<th class="column-title" style="text-align: center;width:15%;">被订阅者</th>--}}
                                    <th class="column-title" style="text-align: center;width:20%;">到期时间</th>
                                    <th class="column-title" style="text-align: center;width:20%;">购买价格</th>
                                    <th class="column-title" style="text-align: center;width:20%;">购买周期</th>
                                    <th class="column-title" style="text-align: center;width:20%;">管理员操作</th>
								</tr>
							</thead>
							<tbody id ='data_list'>
...
<!--            <td style="vertical-align: middle;"><a target="_blank" href="/admin/base_user?uid=<%=data[i].r_uid%>"><%=data[i].r_nickname%>[<%=data[i].r_uid%>]</a></td>-->
            <td style="vertical-align: middle;"><%=data[i].expire_date%></td>
            <td style="vertical-align: middle;"><%=data[i].money%></td>
            ...
            <td style="vertical-align: middle;"><%=data[i].admin%></td>
        </tr>
        <%}%>
</script>
