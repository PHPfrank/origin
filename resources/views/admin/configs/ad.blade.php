...
<div class="right_col" role="main">
    ...
    <script type="text/html" id="item_list">
        ...
        <tr class="even pointer">
			...
			<td class=" " style=""><img src="<%=data[i].img%>" width="150px" height="200px"></td>
			<td class=" " style="vertical-align:middle;"><%=data[i].url%></td>
			<td class=" " style="vertical-align:middle;"><%if(data[i].status==1){%>可见<%}else if(data[i].status==-1){%>不可见<% }%></td>
			<td class=" last" style="vertical-align:middle;">
                <a href="/admin/ad_detail?id=<%=data[i].id%>" target='_blank' class="btn btn-primary btn-sm" ><i class="fa fa-list-ul"></i> 编辑 </a>
