                		...
                		<div id="uploader-demo">
                    		<div id="fileList" class="uploader-list album">
                        		<div id="file_List" val="0">
                            		<%if(data.data[0].img){%>
                        				<a class="example-image-link" data-lightbox="example-set"  href="<%=data.data[0].img%>" rel="lightbox"><img width="300" height="300" src="<%=data.data[0].img%>" ></a>
                            		<%}%>
                            	</div>
                    		</div>
 					...
 					<div class="col-sm-4 ">
            				...
            				<div class="mail_heading row">
								...
								<div class="form-group col-md-12">
                   					...
                   					<div class="col-md-8 col-sm-8 col-xs-8" style="">
                       					<input type="text"  name="title" id="title" class="form-control col-md-3 col-xs-12" value="<%=data.data[0].title%>">
                   					</div>
               					</div>
               					<div class="form-group col-md-12">
                   					<label class="control-label col-md-3 col-sm-3 col-xs-3" for="last-name" style="padding-top: 8px; text-align: right;">内容:
                       					<span class=""></span>
                   					</label>
                   					<div class="col-md-8 col-sm-8 col-xs-8" style="">
                   						<textarea name="content" id="content"><%=data.data[0].content%></textarea>
                   					</div>
               					</div>
               					<div class="form-group col-md-12">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-8" style="">
                                    <select class="select2_single form-control" tabindex="-1" id="type" >
                                        <option value="0" <%if(data.data[0].type==0){%>selected='selected'<%}%>>h5链接</option>
                                        <option value="1" <%if(data.data[0].type==1){%>selected='selected'<%}%>>app内跳转</option>
                                    </select>
                                </div>
                                </div>
                                <div class="form-group col-md-12">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-8" style="">
                                        <input type="text"  name="url" id="color" class="form-control col-md-3 col-xs-12" value="<%=data.data[0].color%>">
                                    </div>
                                </div>
...
<!--                                </div>-->
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-8" style="">
                                    <select class="select2_single form-control" tabindex="-1" id="status" >
                                        ...
                                        <option value="2" <%if(data.data[0].status==2){%>selected='selected'<%}%>>不可见</option>
                                    </select>
                                </div>
                                </div>
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-8" style="">
                                        <input type="text"  name="sort" id="sort" class="form-control col-md-3 col-xs-12" value="<%=data.data[0].sort%>">
                                    </div>
                                </div>
                                <div class="form-group col-md-12">
            ...
            render=function(){
                ...
                $("#info_edit").on("click",function(){
                   var _this={};
                    ...
                    _this.content = $.trim($("#content").val());
                    _this.color = $.trim($("#color").val());
                    //console.log(_this);
                    $.ajax({
                        url:'/admin/api/banner_edit',
                        dataType:"json",
                        type:'post',
                        data:_this,
                        success:function(result){
                ...
                uploader_photo.on( 'uploadSuccess', function( file,response ) {
                    var params = "photo="+response.data+"&id="+$("#id").val();
                    $.post({
                        url:'/admin/api/banner_edit',//添加图片链接数据
                        data:params,
                        success:function(result){
                            console.log(result);
                            init();
