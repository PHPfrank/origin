...
<tr>
<td style="vertical-align: middle;"><a href="/admin/user_resource?uid=<%=data[i].uid%>"><%=data[i].uid%></a></td>
<td>
			...
			$(".btn-success").click(function(){
				...
				$(".btn-danger").click(function(){
				  ...
				  btn: ['确定','取消'] //按钮
						...
						$.ajax({
							url:'/admin/api/findheader_refuse',
							dataType:"json",
							type:'post',
							data:pass_param,
							success:function(result){
