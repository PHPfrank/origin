                ...
                <div class="x_title">
                    ...
                    <form class="form-horizontal form-label-left" style="text-align: left;">
                        <div class="form-group">
                            ...
                            {{--<label class="" for="first-name" style="text-align:left;padding-right:1px;padding-left:1px;padding-top:8px;float:left;">对象:</label>--}}
                            {{--<div class="col-md-2" style="width:12%;">--}}
                                {{--<select class="select2_single form-control" id="type" tabindex="-1">--}}
                                    {{--<option value="all">全部</option>--}}
                                    {{--<option value="2">找对象</option>--}}
                            ...
                            <label class="" for="first-name" style="text-align:left;padding-right:1px;padding-left:1px;padding-top:8px;float:left;">保证金:</label>
                            <div class="col-md-2" style="width:10%;">
                                <select class="select2_single form-control" id="ic_apply_gold" tabindex="-1">
                        ...
                        <div class="form-group">
                            <label class="" for="first-name" style="text-align:left;padding-right:1px;padding-left:1px;padding-top:8px;float:left;">最近活动日期:</label>
                            <div class="col-md-1" style="width:13%;">
                                <input type="text" id="start_active_time"  class="form-control col-md-1 form_datetime" style="border-radius:2px;" placeholder="2016-01-05">
                            </div>

                            <label class="" for="first-name" style="text-align:left;padding-top:8px;float:left;">--至--</label>
                            <div class="col-md-1" style="width:13%;">
                                <input type="text" id="end_active_time"  class="form-control col-md-1 form_datetime" style="border-radius:2px;" placeholder="2016-10-30">
                            </div>
                            <div class="col-md-1">
...
<script type="text/javascript">
	$(function(){
        ...
        $("#search").on("click",function(e){
            ...
            _this.start_active_time =$.trim($("#start_active_time").val());
            _this.end_active_time =$.trim($("#end_active_time").val());
            _this.status=$("#status").val();
            _this.ic_apply_gold=$("#ic_apply_gold").val();
            fetch();
        });
        $("#send_msg").on("click",function(){
            ...
            $.ajax({
                url:'/admin/easemob_send_msg',
                dataType:"json",
                type:'post',
                data:{uid:suid,content:content},
                success:function(result){
                    if(result.error==0){
