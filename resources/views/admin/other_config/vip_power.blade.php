		...
		<div class="page-title">
			...
			<div class="title_right">
				<div
					...
					<div class="input-group"><a target="_blank" href="vip_power_detail" class="btn btn-edit btn-info" id="">添加</a></div>
				</div>
			</div>
...
<script type="text/html" id="item_list">
        ...
        <tr class="even pointer">
            ...
            <td class=" "><img width="60" src="<%=data[i].ico%>"></td>
            <td class=" "><%=data[i].status_msg%></td>
            <td class=" "><%=data[i].is_shenhe_msg%></td>
            <td class=" "><%=data[i].order_by%></td>
            <td class=" ">
                <a href="/admin/vip_power_detail?id=<%=data[i].id%>" target='_blank' class="btn btn-primary btn-sm" ><i class="fa fa-list-ul"></i> 编辑 </a>
            </td>
        </tr>
        <%}%>
</script>
