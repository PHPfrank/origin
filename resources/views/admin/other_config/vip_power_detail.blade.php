...
<div class="right_col" role="main">
    ...
    <div class="x_panel" style="border-top: 1px solid #dddddd;margin-top: 10px;">       
        <form method='post' name='edit' action='api/vip_power_edit'>
            <div class="form-group col-md-12">
                <label class="control-label col-md-3 col-sm-3 col-xs-3" for="last-name" style="padding-top: 8px; text-align: right;">主标题:
                    <span class=""></span>
                </label>
            ...
            <div class="form-group col-md-12">
                <label class="control-label col-md-3 col-sm-3 col-xs-3" for="last-name" style="padding-top: 8px; text-align: right;">副标题:
                    <span class=""></span>
                </label>
                <div class="col-md-8 col-sm-8 col-xs-8" style="">
            ...
            <div class="form-group col-md-12">
                <label class="control-label col-md-3 col-sm-3 col-xs-3" for="last-name" style="padding-top: 8px; text-align: right;">是否审核可见:
                    <span class=""></span>
                </label>
                <div class="col-md-8 col-sm-8 col-xs-8" style="">
                    <input type="radio" name='is_shenhe' @if($info->status==1) checked @endif  value='1'>可见
                    <input type="radio" name='is_shenhe' @if($info->status==2) checked @endif value='2'>不可见
                </div>
            </div>
            <div class="form-group col-md-12">
