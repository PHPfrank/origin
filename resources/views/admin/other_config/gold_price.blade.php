		...
		<div class="page-title">
			...
			<div class="title_right">
				<div
					...
					<div class="input-group"><a target="_blank" href="gold_price_detail" class="btn btn-edit btn-info" id="">添加</a></div>
				</div>
			</div>
...
<script type="text/html" id="item_list">
        ...
        <tr class="even pointer">
            ...
            <td class=" "><%=data[i].gold%></td>
            <td class=" "><%=data[i].money%></td>
            <td class=" "><%=data[i].status_msg%></td>
            <td class=" ">
                <a href="/admin/gold_price_detail?id=<%=data[i].id%>" target='_blank' class="btn btn-primary btn-sm" ><i class="fa fa-list-ul"></i> 编辑 </a>
            </td>
        </tr>
        <%}%>
</script>
