...
<input type="text" id="uid"  class="form-control col-md-1" style="border-radius:2px;" placeholder="">
</div>
		...
		<input type="text" id="uids" name="last-name"
				class="form-control col-md-3 col-xs-12"
						...
						<label class="control-label col-md-2 col-sm-4 col-xs-4"
								...
								<a  class="btn btn-sm btn-warning" id="send_all" >所有用户发送</a>
								</div>
								</div>
								...
								<label class="control-label col-md-2 col-sm-4 col-xs-4"
										...
										<option value="<%=data[i].user_id%>"><%if(data[i].nickname){%><%=data[i].nickname%><%}else{%><%=data[i].user_id%><%}%></option>
										<%}%>
										</select>
										</td>
										<td>
                                                    ...
                                                    layer.prompt({
                                                        ...
                                                        if(value == '520'){
                                                           $.ajax({
                                                            ...
                                                            layer.msg('操作密码错误',{icon:2,time:2000});
                                                        }
                                                    });
                                                });
										});
