			...
			<div class="x_panel">
                <div class="x_title">
                    ...
                    <form class="form-horizontal form-label-left" style="text-align: left;">
                        <div class="form-group">
                            ...
                            <label class="" for="first-name" style="text-align:left;padding-right:1px;padding-left:2px;padding-top:8px;float:left;">手&nbsp;机:</label>
                            <div class="col-md-1" style="width:12%;">
                                <input type="text" id="phone"  class="form-control col-md-1" style="border-radius:2px;" placeholder="13450415526">
                            </div>
                        </div>
                        <div class="form-group">
				...
				<div class="x_content" >
                    ...
                    <div class="col-sm-12">
                        <div class="form-group col-md-12">
                            <label class="control-label col-md-2 col-sm-4 col-xs-4"
                                   for="last-name" style="padding-top: 8px; text-align: right;">发送时间:
                                <span class=""></span>
                            </label>
                            <div class="col-md-8 col-sm-8 col-xs-8" style="">
                                <input type="text" id="send_time" name="last-name"
                        ...
                        <tr>
                            <td>
                                <select style="width: 200px !important;height: 300px;" name="a_uid"  id='a_uid' multiple="multiple" ondblclick="javascript:moveRight()">
                                    ...
                                    <option value="<%=data[i].phone%>"><%if(data[i].nickname){%><%=data[i].nickname%><%}else{%><%=data[i].phone%><%}%></option>
                                    <%}%>
                                </select>
                            </td>
                            <td>
	...
	$(function(){
        ...
        $("#send_msg").on("click",function(){
            ...
            $.ajax({
                ...
                dataType:"json",
                type:'post',
                data:{phone:suid,content:content,send_time:send_time},
                success:function(result){
                    if(result.error==0){
